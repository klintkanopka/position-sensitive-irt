...
def main(run_name, input_path, irt_model, max_epochs, max_iter, 
    ...
    e_opt = torch.optim.Adam(e_params)
    m_opt = torch.optim.Adam(m_params)
...
if __name__ == '__main__':
    ...
    if args.name is not None:
        print('\nFitting {}: {}PL Model to {} with convergence threshold of {}'.format(args.name, args.irt_model, args.input, args.epsilon))
    else:
        print('\nFitting {}PL Model to {} with convergence threshold of {}'.format(args.irt_model, args.input, args.epsilon))
